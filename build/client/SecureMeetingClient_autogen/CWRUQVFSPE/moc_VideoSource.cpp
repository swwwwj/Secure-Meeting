...
#include "../../../../client/video/VideoSource.h"
...
struct qt_meta_stringdata_CLASSVideoSourceENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSVideoSourceENDCLASS = QtMocHelpers::stringData(
    "VideoSource",
    "frameReady",
    "",
    "frame"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSVideoSourceENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject VideoSource::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSVideoSourceENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSVideoSourceENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSVideoSourceENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *VideoSource::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSVideoSourceENDCLASS.stringdata0))
