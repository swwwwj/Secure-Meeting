...
#include "../../../../client/video/CameraVideoSource.h"
...
struct qt_meta_stringdata_CLASSCameraVideoSourceENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCameraVideoSourceENDCLASS = QtMocHelpers::stringData(
    "CameraVideoSource",
    "onFrameChanged",
    "",
    "QVideoFrame",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCameraVideoSourceENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CameraVideoSource::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCameraVideoSourceENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCameraVideoSourceENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCameraVideoSourceENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CameraVideoSource, std::true_type>,
...
void CameraVideoSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onFrameChanged((*reinterpret_cast< std::add_pointer_t<QVideoFrame>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *CameraVideoSource::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCameraVideoSourceENDCLASS.stringdata0))
