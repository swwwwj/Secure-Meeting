...
#include "../../../../client/ui/RegisterWindow.h"
...
Q_CONSTINIT const QMetaObject RegisterWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRegisterWindowENDCLASS_t,
        ...
        // method 'registerSubmitRequested'
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->registerSubmitRequested((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3]))); break;
        ...
        {
            using _t = void (RegisterWindow::*)(const QString & , const QString & , const QString & );
            if (_t _q_method = &RegisterWindow::registerSubmitRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &RegisterWindow::backToLoginRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void RegisterWindow::registerSubmitRequested(const QString & _t1, const QString & _t2, const QString & _t3)
{
